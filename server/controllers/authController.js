...
const updateProfile = async (req, res) => {
  try {
    const { name, preferences, fitnessLevel, goals, primaryActivities, activityLevel, experienceLevel } = req.body;
    const updates = {};
    ...
    if (primaryActivities) updates.primaryActivities = primaryActivities;
