                ...
                >
                  ...
                  <div className="grid gap-4">
                    <button
                      ...
                      disabled={isLoading || Object.keys(journalEntries).length === 0}
                      className="flex items-center space-x-3 p-4 bg-slate-800/50 hover:bg-slate-700/50 rounded-xl border border-slate-600/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                >
                  ...
                  <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-600/50">
                    ...
                    <div className="text-sm text-slate-300 space-y-2">
                      ...
                      <p>• Only JSON files exported from ReflectWithin are supported</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center justify-center space-x-3 p-4 bg-cyan-500 hover:bg-cyan-400 text-slate-900 rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                >
                  ...
                  <div className="grid gap-4">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="flex items-center space-x-3 p-4 bg-red-900/20 hover:bg-red-800/30 rounded-xl border border-red-700/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        ...
                        <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-600/50">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="text-slate-50">{new Date(stats.dateRange.earliest).toLocaleDateString()}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-slate-400">Latest Entry:</span>
                              <span className="text-slate-50">{new Date(stats.dateRange.latest).toLocaleDateString()}</span>
                            </div>
                          </div>
                        </div>
                      )}
