    ...
    <div className="bg-card rounded-2xl border border-border p-6">
      ...
      {isEditing ? (
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="profile-name" className="block text-sm font-light text-muted-foreground mb-2">
              Name
            </label>
            <input
              id="profile-name"
          ...
          <div>
            <label htmlFor="profile-theme" className="block text-sm font-light text-muted-foreground mb-2">
              Theme
            </label>
            <select
              id="profile-theme"
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="profile-notifications" className="ml-2 block text-sm text-foreground font-light">
