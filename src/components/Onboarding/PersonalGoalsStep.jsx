        ...
        <div className="max-w-lg mx-auto mb-8">
          ...
          {showAddForm && (
            ...
            >
              <div className="space-y-4">
                <div>
                  <label htmlFor="goal-title" className="block text-sm font-medium text-white mb-2 text-left">
                    Goal Title
                  </label>
                  <input
                    id="goal-title"
                ...
                <div>
                  <label htmlFor="goal-description" className="block text-sm font-medium text-white mb-2 text-left">
