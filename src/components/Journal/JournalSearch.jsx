...
import { safeCreateDate, getDaysDifference } from '../../utils/dateUtils';
      ...
      .filter(entry => {
        ...
        if (selectedFilters.dateRange !== 'all') {
          ...
          if (!entryDate) {
            ...
            const daysDiff = getDaysDifference(entryDate, today);
            ...
            switch (selectedFilters.dateRange) {
              ...
              case 'custom':
                if (selectedFilters.dateFrom && selectedFilters.dateTo) {
                  const fromDate = safeCreateDate(selectedFilters.dateFrom);
                  const toDate = safeCreateDate(selectedFilters.dateTo);
                  matchesDateRange = fromDate && toDate && entryDate >= fromDate && entryDate <= toDate;
                }
                break;
              default:
